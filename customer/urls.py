...
from .views import CustomerUpdateProfileView,Customerordersfeed,CustomerProfileView ,CustomerSignUpView ,Customermyorders , Customerdeletorders , Customerordersdone
