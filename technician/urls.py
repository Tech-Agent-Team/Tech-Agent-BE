...
urlpatterns=[
    ...
    path('profileupdateInfo/', TechnicianInfoUpdateProfileView.as_view(), name='profile-update'),    path('hometechnician/', homeTechnicianView.as_view(), name='Technician-home'),
